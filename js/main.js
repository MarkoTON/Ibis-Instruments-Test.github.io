    ...
    <div class="row">
      <div class="col-md-12">
        <form class="form-inline pt-3">
          ...
          <div class="col-md-4">
            <div class="input-group ">
              <button type="button" id="resetFilter" class="btn btn-outline-info rounded-50 text-center mb-2 mr-4 px-4  m-auto ml-md-auto  ml-lg-auto  ml-xl-auto" onclick="resetApplay()">
    ...
    <div class="row">
      <div class="col-md-12">
        <form class="form-inline pt-3">
          ...
          <div class="col-md-4">
            <div class="input-group ">
              <button type="button" id="resetFilter" class="btn btn-outline-info rounded-50 text-center mb-2 mr-4 px-4 mr-auto" onclick="resetApplay()">
                <i class="fas fa-sliders-h pr-2"></i>
                Reset filters
              </button>
            </div>
